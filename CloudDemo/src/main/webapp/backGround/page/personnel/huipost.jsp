  ...
  <head>
	...
	<script type="text/javascript">
		layui.use(['table','layer'],function(){
			...
			table.render({
				elem:'#tb',
				url:'ZhiYuanController/selectposit',
				method:'post',
				width:500,
				height:290,
				page:true,
				...
				cols:[[
					...
					{field:'pBId',title:'所属部门',templet:'<div>{{d.pBId.bName}}</div>',align:'center'},
					{field:'right',title:'职位状态',toolbar:'#zuta',align:'center'},
			...
			console.log(obj);
				...
				if(obj.event=='delete'){
					layer.confirm("是否回收该数据?",function(){
						$.post("ZhiYuanController/upposit",{id:data.pId},function(res){
							if(res>0){
