    ...
    <form  class="layui-form">
		...
		<div class="layui-form-item"style="margin-top: 20">
  			...
  			<div class="layui-input-inline">
  				<input id="S_name" name="sName" class="layui-input" placeholder="请输入员工名称" style="width: 300" autocomplete="off" disabled lay-verify="required"/>
  		...
  		<div class="layui-form-item"style="margin-top: 20">
  			...
  			<div class="layui-input-inline">
  				<input id="S_login" name="sEntrytime" type="text" class="layui-input" id="test3" placeholder="请输入入职时间" disabled style="width:300px">
  			</div>
  		</div>
