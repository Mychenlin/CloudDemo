		...
		var form=layui.form,$=layui.$,layer=layui.layer;
  			 ...
  			 //从父层获取值，json是父层的全局js变量。eval是将该string类型的json串变为标准的json串
		        var j = eval('('+parent.json+')');
					 ...
					 $.post("position/querbum",function(res){
		        ...
		        form.on('submit(update)',function(){
  				...
  				$.post("position/uptadePosition",formData,function(res){
  					if(res>0){
  ...
  <body>
    <form class="layui-form">
	    ...
	    <div class="layui-input-block">
	      <input type="text" id="name" name="PName" required  lay-verify="required" placeholder="请输入姓名" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	 	<div class="layui-form-item"style="margin-top: 20px; width:410px;" >
  			<label class="layui-form-label">部门选择</label>
		    <div class="layui-input-block">
		      <select id="serviceType" name="PBId.BId">
		...
		<div class="layui-form-item" style="margin-top: 20px; width:410px;">
		    ...
		    <div class="layui-input-inline">
		      <input type="text" id="remark" name="PRemark" required lay-verify="required" placeholder="请输入密码" autocomplete="off" class="layui-input">
		    </div>
    	</div>
