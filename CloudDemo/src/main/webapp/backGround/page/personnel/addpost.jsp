	...
	<script type="text/javascript">
		layui.use(['form','layer'],function(){
			...
			form.on('submit(add)',function(){
				...
				$.post("position/addPosition",formData,function(res){
					if(res>0){
    ...
    <form class="layui-form" method="post" action="">
  		<div class="layui-form-item"style="margin-top: 20">
  			...
  			<div class="layui-input-inline">
  				<input name="pName" class="layui-input" placeholder="请输入职位名" style="width: 300" autocomplete="off" lay-verify="required"/>
  			</div>
  		</div>
  		...
  		<div class="layui-form-item" style="margin-top: 20">
  			...
  			<div class="layui-input-inline">
  				<input name="pRemark" class="layui-input" style="width: 300" placeholder="请输入备注" autocomplete="off"/>
  			</div>
  		</div>
