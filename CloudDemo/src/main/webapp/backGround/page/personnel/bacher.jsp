  ...
  <head>
	...
	<script type="text/javascript">
		layui.use(['table','layer'],function(){
			...
			table.render({
				elem:'#tb',
				url:'Branch/selectAllBranch',
				method:'post',
				page:true,
				limit:5,
				limits:[5,10,15],
				cols:[[
					{field:'bId',title:'部门编号'},
			...
			$("#hui").click(function(){
				layer.open({
					type:2,
					title:'回收站',
					content:'backGround/page/personnel/huibacher.jsp',
					area:['500px','500px'],
					shade:0.5,
					btn:'关闭',
					resize:false,  //不允许拉伸
			...
			$("#addBtn").click(function(){
				layer.open({
					type:2,
					title:'添加部门',
					content:'backGround/page/personnel/addbrach.jsp',
					area:['450px','400px'],
					shade:0.5,
					btn:'关闭',
					resize:false,  //不允许拉伸
			...
			console.log(obj);
				...
				//将一个JavaScript值(对象或者数组)转换为一个 JSON字符串
					...
					layer.open({
						type:2,
						title:'修改部门',
						content:'backGround/page/personnel/updatebacher.jsp',
						area:['450px','400px'],
						shade:0.5,
						btn:'关闭',
						resize:false,   //不允许拉伸
				...
				if(obj.event=='delete'){
					layer.confirm("是否删除该数据?",function(){
						$.post("Branch/deleteBranch",{id:data.bId},function(res){
							if(res>0){
