	...
	<script type="text/javascript">
		layui.use(['form','layer'],function(){
			...
			form.on('submit(add)',function(){
				...
				$.post("Branch/addBranch",formData,function(res){
					if(res>0){
    ...
    <form class="layui-form" method="post" action="">
  		<div class="layui-form-item"style="margin-top: 20">
  			...
  			<div class="layui-input-inline">
  				<input name="bName" class="layui-input" placeholder="请输入部门名称" style="width: 300" autocomplete="off" lay-verify="required"/>
  			</div>
  		</div>
  		<div class="layui-form-item" style="margin-top: 20">
  			<label class="layui-form-label">部门备注：</label>
  			<div class="layui-input-inline">
  				<input name="bRemark" class="layui-input" style="width: 300" placeholder="请输入备注" autocomplete="off"/>
  			</div>
  		</div>
