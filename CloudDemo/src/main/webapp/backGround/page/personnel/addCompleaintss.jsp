	...
	<script type="text/javascript">
		layui.use(['form','layer'],function(){
			...
			form.on('submit(add)',function(){
				...
				$.post("Compleaints/insertComplsA",formData,function(res){
					if(res>0){
    ...
    <form class="layui-form" method="post" action="">
  		<div class="layui-form-item"style="margin-top: 20">
  			...
  			<div class="layui-input-inline">
  				<input name="cName" class="layui-input" placeholder="请输入反馈人" style="width: 300" autocomplete="off" lay-verify="required"/>
  			</div>
  		</div>
  		<div class="layui-form-item" style="margin-top: 20">
  			<label class="layui-form-label">反馈意见：</label>
  			<div class="layui-input-inline">
  				<input name="cremark" class="layui-input" style="width: 300" placeholder="请输入反馈意见" autocomplete="off"/>
  			</div>
  		</div>
