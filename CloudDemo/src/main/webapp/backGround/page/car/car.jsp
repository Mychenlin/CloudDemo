	...
	<style type="text/css">
  	...
  	<script type="text/javascript">
  		...
  		layui.use(['table'],function(){
  			...
  			table.render({
  				elem:'#tb',
  				url:'${pageContext.request.contextPath}/carC/show',
  				method:'post',
  				page:true,
  				limit:10,
  				limits:[10,20,30],
  				cols:[[
  						{field:'initials',title:'首字母',width:80,align:'center'},
  						{field:'pic_url',title:'图片',width:150,templet:"<div><img id='img' src='${pageContext.request.contextPath }/{{d.pic_url}}'></div>",align:'center'},
  						{field:'name',title:'品牌',width:200,align:'center'},
  						{field:'status',title:'是否显示',templet:"<div>{{d.status==1?'是':'否'}}</div>",width:150,align:'center'},
  						{field:'is_hot',title:'是否热门',templet:"<div>{{d.is_hot==0?'是':'否'}}</div>",width:150,align:'center'},
