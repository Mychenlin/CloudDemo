...
<html>
	...
	<script type="text/javascript">
		layui.use(['form','layer'],function(){
			...
			form.on('submit(add)',function(){
				...
				$.post("RepySMSController/intre",formData,function(res){
					if(res>0){
  ...
  <body>
    <form class="layui-form" method="post" action="">
    	<input type="hidden" name="rrId.rId" id="idss"/> 
  		<div class="layui-form-item"style="margin-top: 20">
  			<label class="layui-form-label">回复内容：</label>
  			<div class="layui-input-inline">
  				<input name="rRemark" class="layui-input" placeholder="请输入回复内容" style="width: 300" autocomplete="off" lay-verify="required"/>
  			</div>
  		</div>
