	...
	<script type="text/javascript">
		layui.use(['form','layer'],function(){
			...
			form.on('submit(add)',function(){
				...
				$.post("MenDianController/addMedian",formData,function(res){
					if(res>0){
    ...
    <form class="layui-form" method="post" action="">
  		<div class="layui-form-item"style="margin-top: 20">
  			...
  			<div class="layui-input-inline">
  				<input name="mName" class="layui-input" placeholder="请输入门店名称：" style="width: 300" autocomplete="off" lay-verify="required"/>
  			</div>
  		</div>
  		<div class="layui-form-item"style="margin-top: 20">
  			<label class="layui-form-label">负责人：</label>
  			<div class="layui-input-inline">
  				<input name="mFname" class="layui-input" placeholder="请输入负责人名称" style="width: 300" autocomplete="off" lay-verify="required"/>
  			</div>
  		</div>
  		<div class="layui-form-item"style="margin-top: 20">
  			<label class="layui-form-label">联系方式：</label>
  			<div class="layui-input-inline">
  				<input name="mIp" class="layui-input" placeholder="请输入联系方式" style="width: 300" autocomplete="off" lay-verify="required"/>
  			</div>
  		</div>
  		<div class="layui-form-item"style="margin-top: 20">
  			<label class="layui-form-label">门店地址：</label>
  			<div class="layui-input-inline">
  				<input name="mTzT" class="layui-input" placeholder="请输入门店地址" style="width: 300" autocomplete="off" lay-verify="required"/>
  			</div>
  		</div>
